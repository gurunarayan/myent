...
<div class="quickLinksDiv">
	...
	{if $CURRENT_VIEW == 'Detail'}
		<p onclick="window.location.href='index.php?module=Instances&view=Analyser&record={$RECORD->getId()}'" id="analyser" 
		class="unSelectedQuickLink">
			<a class="quickLinks" href="index.php?module=Instances&view=Analyser&record={$RECORD->getId()}"><strong>Analyser</strong></a>
		</p>
		
		<p onclick="window.location.href='index.php?module=Instances&view=Nagios&record={$RECORD->getId()}'" id="nagios" 
		class="unSelectedQuickLink">
			<a class="quickLinks" href="index.php?module=Instances&view=Nagios&record={$RECORD->getId()}"><strong>Nagios</strong></a>
		</p>
	{/if}
</div>
{/strip}
