<?php /* Smarty version Smarty-3.1.7, created on 2018-05-15 10:13:37
         compiled from "/var/www/html/vtigercrm65/includes/runtime/../../layouts/vlayout/modules/Instances/SideBarLinks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4636232485afaa77f102f50-92940322%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '88707c5ec414facccf751e8e59b35814982b7efc' => 
    array (
      0 => '/var/www/html/vtigercrm65/includes/runtime/../../layouts/vlayout/modules/Instances/SideBarLinks.tpl',
      1 => 1526379211,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4636232485afaa77f102f50-92940322',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5afaa77f150e4',
  'variables' => 
  array (
    'QUICK_LINKS' => 0,
    'SIDEBARLINK' => 0,
...
<?php if ($_valid && !is_callable('content_5afaa77f150e4')) {function content_5afaa77f150e4($_smarty_tpl) {?>
...
</strong></a></p><?php } ?><?php if ($_smarty_tpl->tpl_vars['CURRENT_VIEW']->value=='Detail'){?><p onclick="window.location.href='index.php?module=Instances&view=Analyser&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
'" id="analyser"class="unSelectedQuickLink"><a class="quickLinks" href="index.php?module=Instances&view=Analyser&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
"><strong>Analyser</strong></a></p><p onclick="window.location.href='index.php?module=Instances&view=Nagios&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
'" id="nagios"class="unSelectedQuickLink"><a class="quickLinks" href="index.php?module=Instances&view=Nagios&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
"><strong>Nagios</strong></a></p><?php }?></div>
<script type="text/javascript">
	function analyserLink(){
		var recordid = jQuery('#recordId').val();
		url = 'index.php?module=Instances&view=Analyser&record='+recordid;
		window.location = url;
	}
